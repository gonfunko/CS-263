...
void increment_progress() {
    ppb_messaging_interface->PostMessage(g_instance, CStrToVar("increment"));
}

void finish_crushing(double reduction) {
	ppb_messaging_interface->PostMessage(g_instance, PrintfToVar("It's now %4.2f%% smaller!", reduction));
}
...
static void HandleMessage(char* message) {
	    ...
	    char* arg2 = (char*)"/persistent/input.png";
	    char* arg3 = (char*)"/persistent/output.png";
	    char* argv[] = {arg1, arg2, arg3};
	    
	    int result = main_func(3, argv);
    	    ppb_messaging_interface->PostMessage(g_instance, CStrToVar("done"));
   }
...
static PP_Bool Instance_DidCreate(PP_Instance instance,
  ...
  mount(
      ...
      0,  /* mountflags */
      "type=PERSISTENT,expected_size=10485760");  /* data */
